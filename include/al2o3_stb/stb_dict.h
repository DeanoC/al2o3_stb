...
stb_declare_fixed_sized_hash(AL2O3_EXTERN_C, stb_ptrmap, stb_ptrmap_, void *, void *)
stb_declare_fixed_sized_hash(AL2O3_EXTERN_C, stb_idict32, stb_idict32_, int32_t, int32_t)
stb_declare_fixed_sized_hash(AL2O3_EXTERN_C, stb_udict32, stb_udict32_, uint32_t, uint32_t)
stb_declare_fixed_sized_hash(AL2O3_EXTERN_C, stb_idict64, stb_idict64_, int64_t, int64_t)
stb_declare_fixed_sized_hash(AL2O3_EXTERN_C, stb_udict64, stb_udict64_, uint64_t, uint64_t)

AL2O3_EXTERN_C void stb_udict32_reset(stb_udict32 *e);
AL2O3_EXTERN_C void stb_idict32_reset(stb_idict32 *e);
AL2O3_EXTERN_C void stb_udict64_reset(stb_udict64 *e);
AL2O3_EXTERN_C void stb_idict64_reset(stb_idict64 *e);
